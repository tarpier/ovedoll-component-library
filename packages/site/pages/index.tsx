...
export default function Home({ pageContent }) {
  ...
  return (
    <>
      <MyPageSeo
        path="/"
        title="I build fast and secure websites for your online business."
        description="I'm a Freelance Frontend Developer with over 10 years of experience. You can hire me to help with your Frontend / Jamstack project today."
      />
